...
describe 'navigate' do
 ...
 describe 'index' do
    ...
    it 'has a scope so that only post creaters can see their posts' do
        post1 = Post.create(date: Date.today, rationale: "Some content", user_id: user.id)
 ...
 describe 'delete' do
    it 'can be deleted' do
        ...
        post_to_delete = Post.create(date: Date.today, rationale: 'asdf', user_id: delete_user.id, overtime_request: 3.0)
        visit posts_path
